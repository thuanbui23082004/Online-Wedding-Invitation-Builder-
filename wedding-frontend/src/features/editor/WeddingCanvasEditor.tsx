      ...
      <header className="z-20 flex h-14 shrink-0 items-center justify-between bg-[#161620] px-6 text-white shadow-sm">
        <div className="flex items-center space-x-6">
          <Link to="/dashboard/my-cards" className="flex items-center gap-2 text-xl font-black text-white hover:opacity-80">
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-linear-to-br from-rose-400 to-pink-600 text-sm shadow-sm shadow-rose-500/40">
              L
            </span>
            loveyou
          </Link>
        ...
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            className="rounded-lg bg-linear-to-r from-rose-500 to-pink-600 px-5 py-1.5 text-xs font-bold text-white shadow-md shadow-rose-500/30 transition-opacity hover:opacity-90"
          >
            Xuất bản
          </button>
        </div>
